...
│   │   ├── import_f2_downloads.py # f2 抖音下载目录 → 素材库（扫描报表 / --apply 入库 / --fetch 增量下载 / 我的喜欢 / --rollback 批次回滚）
